...
<div class="container">
    <a href="{{ url('/topup/' . ($gameName ?? session('order_data.game_name', 'MLBB'))) }}" id="btnBackToDetail" class="btn-back-ajax">&larr; Kembali ke Pilih Nominal</a>

    <h2>Instruksi Pembayaran</h2>
    
    <div class="card">
        <p style="margin-top:0; font-size: 0.9rem;">Transfer sesuai nominal ke rekening berikut:</p>
        @foreach($metode_list as $bank => $nomor)
            <div class="bank-item">
                <span class="bank-name">{{ $bank }}</span>
                <span class="bank-number">{{ $nomor }}</span>
            </div>
        @endforeach
        <div class="bank-item">
    ...
    <form id="formPembayaran" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div id="qris-container">
                ...
                <img src="{{ asset('QR.jpg') }}" alt="QRIS Code">
            </div>
