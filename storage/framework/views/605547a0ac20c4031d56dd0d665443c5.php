...
<head>
    ...
    <title>Top Up <?php echo e($gameName); ?></title>
    <style>
...
<div class="container">
    ...
    <a href="<?php echo e(secure_url('/topup')); ?>" id="btnBack" class="btn-back">&larr; Kembali ke Pilih Game</a>

    <!-- Menggunakan secure_url agar aman dari warning Ngrok HTTPS -->
    <form id="formTopup" action="<?php echo e(secure_url('/topup/pilih-pembayaran')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="game_name" value="<?php echo e($gameName); ?>">

        <!-- Info Game -->
        <div class="section-box">
            <div class="game-header">
                <img src="<?php echo e(asset($gameData['logo'])); ?>" class="game-logo" alt="<?php echo e($gameName); ?>"> 
                <span>Top Up <?php echo e($gameName); ?></span>
            </div>
        </div>
        ...
        <div class="section-box">
            ...
            <div class="price-list">
                <?php $__currentLoopData = $gameData['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label style="cursor: pointer;">
                    <input type="radio" name="nominal" value="<?php echo e($item['label']); ?>" required style="display:none">
                    <div class="price-item">
                        <span style="font-size: 1rem; font-weight: bold; color: white;"><?php echo e($item['label']); ?></span>
                        <span style="font-size: 0.85rem; color: #94a3b8;">TPG Diamond <?php echo e($gameName); ?></span>
                        <b style="font-size: 1.1rem; color: #22c55e; margin-top: 2px;">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></b>
                    </div>
                </label>
...
</html><?php /**PATH C:\laragon\www\topup-game\resources\views/detail-game.blade.php ENDPATH**/ ?>